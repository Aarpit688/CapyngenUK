...
const Banner1 = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-black py-16 lg:py-20 xl:py-24">
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
            {/* Right Image Section (order first on mobile, second on desktop) */}
            ...
            {/* Left Content (order second on mobile, first on desktop) */}
