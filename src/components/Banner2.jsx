...
const Banner2 = ({
  title = "Quality resources shared by the community",
  subtitle = "Access premium development resources created and curated by expert developers worldwide.",
  buttonText = "Get access to 4,958 resources",
  buttonLink = "#",
