...
const Banner3 = ({
  ...
  return (
    <section>
      {/* Hero Section */}
      <div className="relative h-screen overflow-hidden bg-black py-16 lg:py-20 xl:pt-40">
        ...
        <div className="absolute inset-0 hidden lg:block">
          ...
          <div className="relative border border-gray-700/30 rounded-3xl m-4 overflow-hidden">
            {/* Background Image */}
            <img
        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-xl mx-auto text-center lg:max-w-md xl:max-w-3xl lg:text-left lg:mx-0">
            <h1 className="text-3xl font-bold text-white sm:text-4xl xl:text-6xl xl:leading-tight">
              {title}
            </h1>

            <p className="mt-8 text-lg font-normal leading-7 text-gray-300 lg:max-w-xl xl:pr-0 lg:pr-16">
              {description}
            </p>
