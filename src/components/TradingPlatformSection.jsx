...
const TradingPlatformSection = ({
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-black text-white overflow-hidden bg-gradient-to-br from-fuchsia-500/70 via-indigo-500/70 to-cyan-400/70 shadow-[0_8px_24px_rgba(99,102,241,0.35)]">
      <div
      ...
      >
        ...
        <div className="w-full md:w-1/2 mt-12 md:mt-0">
          <div className="rounded-3xl p-[1px] ">
            ...
            <button className="bg-gradient-to-r from-fuchsia-500 via-indigo-500 to-cyan-400 hover:opacity-90 text-white font-semibold py-3 px-6 rounded-full flex items-center gap-2 transition-all duration-300 shadow-[0_8px_24px_rgba(99,102,241,0.35)]">
              {buttonText}
