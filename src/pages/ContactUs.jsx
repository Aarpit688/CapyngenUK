          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 backdrop-blur-xl h-full flex flex-col justify-between">
            ...
            <div className="mt-12 pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://www.facebook.com/profile.php?id=100086626928653" target="_blank" rel="noreferrer" className="w-11 h-11 flex items-center justify-center rounded-xl bg-white/5 border border-white/5 text-slate-400 hover:bg-[#1877F2] hover:text-white transition-all">
